...
Característica: Registrar los datos iniciales
  ...
  Escenario: Registrar los datos del titular
    ...
    Ejemplos:
      | nombreTitular | apellidoPaternoTitular | apellidoMaternoTitular | sexoTitular | edadTitular |
      | KARINA        | SANCHEZ                | ESCOBEDO               | F           |          28 |
      | DANIEL        | GARCIA                 | MORALES                | M           |          22 |
      | JOSE DAMIAN   | MENDOZA                | CARMONA                | M           |          24 |