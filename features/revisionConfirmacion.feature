...
Antecedentes:
  ...
  Esquema del escenario: Escenario de prueba (Flujo completo)
    ...
    Y Valido si se encuentra la frase "Sin coberturas adicionales" en la página 1 del archivo
    Y Valido si se encuentra la frase "30%" en la página 1 del archivo
    ...
    Y Valido si se encuentra la frase "16%" en la página 2 del archivo
    Y Valido si se encuentra la frase "MATRIZ" en la página 2 del archivo
    Y Valido si se encuentra la frase "009009" en la página 2 del archivo
    Y Valido si se encuentra la frase "OSCAR GARCIA" en la página 2 del archivo
    Y Valido si se encuentra la frase "Agente" en la página 2 del archivo
    Y Valido si se encuentra la frase "Anual" en la página 2 del archivo
    Y Cierro el PDF del navegador
    Y Regreso a la ventana principal
